...
class PhotoData(models.Model):
    '''写真データを管理するモデル
    '''
    # CustomUserモデル(のuser_id)とPhotoDataモデルを
    # 1対多の関係で結び付ける
    # CustomUserが親でPhotoDataが子の関係となる
    ...
    # Categoryモデル(のtitle)とPhotoDataモデルを
    # 1対多の関係で結び付ける
    # Categoryが親でPhotoDataが子の関係となる
